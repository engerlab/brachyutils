...
class CyberknifeVSI(BeamModel):
    model_name = "cyberknifeVSI"
    folder = "BEAM_cyberknifeVSI"
    pegs_file = "radify"
    particle = "photon"
    ...
    def _process_beams(self, beam, positioning_error=None, orient="HFS"):
        ...
        for cpt in beam["cpts"]:
            ...
            cpt_dict["dsource"] = round(SAD / 10.0 - 50.0, 5) # Must change this if the air gap is changed in the model
    ...
    def _write_dosxyznrc_input(self,  params):
		cpt_strings = []
		cpt_string = "%.5f, %.5f, %.5f, %.5f, %.5f, %.5f, %.5f, %.6f"
		...
		dosxyznrc_filename = params["name"] + "_dosxyznrc.egsinp"
