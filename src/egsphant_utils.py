...
from dose_utils import get_body_index_range, get_body_contour_range_from_many_patients_dicom
...
def crop_by_body_contour_many_files(patient_egsphant_dir:str, patient_body_range_json:str):
    ...
    Input:
        ...
        patient_body_range_json := a json file holding the list of the patient directory names
            ...
            This file can be generated by running the command get_body_contour_range_from_many_patients_dicom. 
            Example:
                [
                    {
                    "patient_number": "p1",
...
# @app.command()
# get_body_contour_range_from_many_patients_dicom()
