...
class Config_Angled_CathGen(BaseModel):
    ...
    ### Attributes:    
    - alt_max  : maximum altitude angle away from normal (degrees); sweeps from -alt_max to +alt_max.
    ...
    alt_max: float = Field(default=10, description="maximum altitude angle away from normal (degrees); \
        sweeps from -alt_max to +alt_max. 0 means parallel to normal, 90 means perpendicular to normal.")
