...
class Config_Angled_CathGen(BaseModel):
    ...
    ### Attributes:    
    - rl_max  : maximum angle away from normal rotating on the right-left (rl) axis (x) (degrees);
    sweeps -rl_max to +rl_max. 0 means parallel to normal, 90 means perpendicular to normal.
